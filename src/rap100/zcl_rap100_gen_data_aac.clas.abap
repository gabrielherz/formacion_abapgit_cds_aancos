CLASS zcl_rap100_gen_data_aac DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_aac IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'AAC',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_aac.
*    DELETE FROM zrap100_daac.

    "insert travel demo data
    INSERT zrap100_aac  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP100_AAC{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
